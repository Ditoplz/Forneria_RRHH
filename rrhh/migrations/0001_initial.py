    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_login', models.DateTimeField(blank=True, null=True)),
                ('rol', models.CharField(choices=[('admin', 'Administrador'), ('empleado', 'Empleado'), ('cliente', 'Cliente'), ('vendedor', 'Vendedor'), ('contador', 'Contador')], max_length=50)),
                ('empleado', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='usuario_asociado', to='rrhh.empleado')),
            ],
        ),
    ]
